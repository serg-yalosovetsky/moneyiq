...
import org.pixelrush.moneyiq.util.reminderOffsetDays
import org.pixelrush.moneyiq.util.startOfDay
...
class RepeatTransactionWorker(
    ...
    private suspend fun updateBalance(accDao: AccountDao, tx: org.pixelrush.moneyiq.data.db.entities.TransactionEntity) {
        when (tx.type) {
    ...
    companion object {
        ...
        const val REMINDER_CHANNEL_ID = "moneyiq_repeat_reminder"
